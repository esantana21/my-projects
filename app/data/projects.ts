...
export const projects: Project[] = [
  ...
  },
  {
    id: 9,
    title: "Impulso360",
    description: "An AI-powered intelligent assistant system that leverages Large Language Models (LLM) with Retrieval-Augmented Generation (RAG) technology. The platform integrates with WhatsApp API to create a conversational bot that can perform queries, maintain conversation records, and provide intelligent responses based on a comprehensive knowledge base. The system processes user inputs, retrieves relevant information from the knowledge base, and generates contextual responses using advanced AI techniques.",
